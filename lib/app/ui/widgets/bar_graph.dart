import 'package:bar_graphs/app/ui/widgets/bar_graph_widgets.dart';
import 'package:flutter/material.dart';
// import '../models/month_amount.dart';
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (orientation == BarGraphOrientation.horizontal) {
      ...
      for (int i = 0; i < data.length; i++) {
        ...
        textPainter.paint(
          canvas,
          Offset(left + width + 4, y + (barThickness - textPainter.height) / 2),
        );
        textPainter.text = TextSpan(
          text: d.month,
        ...
        textPainter.paint(
          canvas,
          Offset(4, y + (barThickness - textPainter.height) / 2),
        );
      }
    }
  }
